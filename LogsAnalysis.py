...
def get_days_lead_errors():
    ...
    query = """
            ...
            from
            (select time::date as day, COUNT(*) as abc from log where status = '404 NOT FOUND' group by day) as errors
            join
            (select time::date as day, COUNT(*) as views from log  group by day) as total
